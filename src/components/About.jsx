...
import { CheckCircle2, Flame, ArrowRight, Play } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-4 sm:right-6 glass-card p-5 rounded-xl max-w-xs border border-[#ff5500]/50 hidden sm:block z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <strong className="block text-sm text-white font-bold">Steam Bath Available</strong>
                  <span className="text-xs text-[#ff5500]">Post-Workout Muscle Recovery</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 text-base leading-relaxed mb-6">
              MSquare Fitness & Wellness Club is Devlali Camp’s premier health and training centre on Mahalaxmi Road. Fully equipped with heavy strength machinery, cardio suites, crossfit rigs, steam bath recovery, and expert personal trainers under the guidance of Akshay Shelke.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {[
                ...
                "Diet Orientation & Nutrition",
                "Steam Bath Muscle Recovery"
              ].map((feat, idx) => (
