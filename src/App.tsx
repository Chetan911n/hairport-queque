...
const INITIAL_SAMPLE_TICKETS: Ticket[] = [
  {
    ...
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 86400 * 15 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 15 + 1800 }
  },
  {
    docId: "hist-002",
    id: "#002",
    ...
    paymentMethod: "UPI",
    stylistName: "Prashant",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 86400 * 14 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 14 + 3600 }
  },
  {
    docId: "hist-003",
    id: "#003",
    ...
    paymentMethod: "Cash",
    stylistName: "Tejas",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 86400 * 13 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 13 + 3600 }
  },
  {
    docId: "hist-004",
    id: "#004",
    ...
    paymentMethod: "UPI",
    stylistName: "Kunal",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 86400 * 12 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 12 + 2700 }
  },
  {
    docId: "hist-005",
    id: "#005",
    ...
    phone: "9819087654",
    serviceType: "Beard Colour, Clean Shave",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 500,
    paymentMethod: "Cash",
    stylistName: "Tejas",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 86400 * 11 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 11 + 1800 }
  },
  {
    docId: "hist-006",
    id: "#006",
    ...
    phone: "9833445566",
    serviceType: "Root Touch Up, Facial",
    ...
    paymentMethod: "UPI",
    stylistName: "Prashant",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 86400 * 10 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 10 + 3600 }
  },
  {
    docId: "hist-007",
    id: "#007",
    ...
    phone: "9711223344",
    serviceType: "Hair Spa, Head Massage",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 950,
    paymentMethod: "Cash",
    stylistName: "Kunal",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 86400 * 9 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 9 + 1800 }
  },
  {
    docId: "hist-008",
    id: "#008",
    ...
    paymentMethod: "UPI",
    stylistName: "Prashant",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 86400 * 8 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 8 + 3600 }
  },
  {
    docId: "hist-009",
    id: "#009",
    ...
    paymentMethod: "UPI",
    stylistName: "Tejas",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 86400 * 7 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 7 + 3600 }
  },
  {
    docId: "hist-010",
    id: "#010",
    ...
    paymentMethod: "Cash",
    stylistName: "Kunal",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 86400 * 6 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 6 + 3600 }
  },
  {
    docId: "hist-011",
    id: "#011",
    ...
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 5 + 2700 }
  },
  {
    docId: "hist-012",
    id: "#012",
    ...
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 4 + 1800 }
  },
  {
    docId: "hist-013",
    id: "#013",
  ...
  },
  {
    docId: "hist-020",
    id: "#020",
    customerName: "Yashwardhan Rana",
    phone: "9822445566",
    serviceType: "Haircut, Hair Wash, Beard Style",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 550,
    ...
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 27000 }
  },
  {
    docId: "hist-021",
    id: "#021",
    ...
    phone: "9819332211",
    serviceType: "Head Massage, Beard Colour",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 700,
    paymentMethod: "UPI",
    stylistName: "Kunal",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 25200 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 23400 }
  },
  {
    docId: "hist-022",
    id: "#022",
    customerName: "Shalini Tiwari",
    phone: "9769887766",
    serviceType: "Threading, Face Waxing, Clean Up",
    serviceCategory: "Skin",
    gender: "Female",
    status: "Completed",
    price: 850,
  ...
  },
  {
    ...
    phone: "9823112233",
    serviceType: "Hair Colour, Head Massage",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 900,
    ...
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 16200 }
  },
  {
    docId: "hist-024",
    id: "#024",
    ...
    phone: "9833009988",
    serviceType: "Rica Waxing, Facial & Cleanup",
    serviceCategory: "Waxing",
    gender: "Female",
    status: "Completed",
    price: 2300,
  ...
  },
  {
    ...
    phone: "9820556677",
    serviceType: "Executive Haircut, Beard Trim",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 450,
    paymentMethod: "Cash",
    stylistName: "Prashant",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 9000 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 7800 }
  },
  {
    docId: "hist-027",
    id: "#027",
    ...
    phone: "9819776655",
    serviceType: "Scalp Detox, Deep Tissue Massage",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 1850,
  ...
  },
  {
    docId: "hist-028",
    id: "#028",
    customerName: "Anita Hassanandani",
    phone: "9833112244",
    serviceType: "Keratin Spa, Hair Cut",
    serviceCategory: "Treatments",
    gender: "Female",
    status: "Completed",
    price: 3100,
  ...
  },
  {
    ...
    phone: "9769334455",
    serviceType: "Classic Haircut, Face Steam",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 500,
  ...
  },
  {
    ...
    phone: "9820445566",
    serviceType: "Textured Fade, Beard Sculpting",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 750,
    ...
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 2400 }
  },
  {
    docId: "hist-031",
    id: "#031",
    ...
    phone: "9821990011",
    serviceType: "Highlights & Balayage, Hair Spa",
    serviceCategory: "Hair",
    gender: "Female",
    status: "Completed",
    price: 4200,
  ...
  },
  {
    ...
    phone: "9833556677",
    serviceType: "Root Touchup, Blowdry",
    serviceCategory: "Hair",
    gender: "Female",
    status: "Completed",
    price: 1650,
  ...
  },
  {
    ...
    phone: "9820778899",
    serviceType: "Hair Spa, Beard Grooming",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 1250,
  ...
  },
  {
    ...
    phone: "9820123987",
    serviceType: "Keratin Treatment & Blow Dry",
    serviceCategory: "Treatments",
    gender: "Female",
    status: "Completed",
    price: 3800,
    ...
    stylistName: "Chetan",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 86400 * 2 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 86400 * 2 + 3600 }
  },
  {
    docId: "hist-038",
    id: "#038",
    ...
    phone: "9821889900",
    serviceType: "Messy Quiff Haircut, Scalp Massage",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 800,
  ...
  },
  {
    ...
    phone: "9833776655",
    serviceType: "Hair Spa, Manicure, Pedicure",
    serviceCategory: "Hair",
    gender: "Female",
    status: "Completed",
    price: 2500,
  ...
  },
  {
    ...
    phone: "9820554411",
    serviceType: "Hydra Facial, Hair Styling",
    serviceCategory: "Skin",
    gender: "Female",
    status: "Completed",
    price: 3900,
  ...
  },
  {
    ...
    phone: "9769112233",
    serviceType: "Hair Tint, Hair Wash, Styling",
    serviceCategory: "Hair",
    gender: "Female",
    status: "Completed",
    price: 1850,
  ...
  },
  {
    docId: "hist-042",
    id: "#042",
    customerName: "Tiger Shroff",
    phone: "9823445566",
    serviceType: "Crew Cut & Beard Line-up",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 500,
    ...
    stylistName: "Prashant",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 36000 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 34200 }
  },
  {
    docId: "hist-043",
    id: "#043",
    customerName: "Disha Patani",
    phone: "9819223344",
    serviceType: "Keratin Treatment, De-Tan",
    serviceCategory: "Treatments",
    gender: "Female",
    status: "Completed",
    price: 3600,
  ...
  },
  {
    ...
    phone: "9820334455",
    serviceType: "Haircut, Face Scrub, Steam",
    serviceCategory: "Skin",
    gender: "Male",
    status: "Completed",
    price: 850,
  ...
  },
  {
    docId: "hist-045",
    id: "#045",
    customerName: "Bhumi Pednekar",
    phone: "9833224455",
    serviceType: "Deep Conditioning Spa, Facial",
    serviceCategory: "Skin",
    gender: "Female",
    status: "Completed",
    price: 2100,
  ...
  },
  {
    ...
    phone: "9769556677",
    serviceType: "Classic Haircut, Head Massage",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 400,
    ...
    stylistName: "Prashant",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 14400 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 12600 }
  },
  {
    docId: "hist-047",
    id: "#047",
    ...
    phone: "9823667788",
    serviceType: "Hair Wash, Beard Trim, Face Steam",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 600,
    ...
    stylistName: "Tejas",
    timestamp: { seconds: Math.floor(Date.now() / 1000) - 10800 },
    completedAt: { seconds: Math.floor(Date.now() / 1000) - 9000 }
  },
  {
    docId: "hist-048",
    id: "#048",
    ...
    phone: "9819889900",
    serviceType: "Haircut, Clean Shave",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 450,
  ...
  },
  {
    ...
    phone: "9820776655",
    serviceType: "Hair Styling, Beard Design",
    serviceCategory: "Hair",
    gender: "Male",
    status: "Completed",
    price: 800,
  ...
  },
  {
    ...
    phone: "9833990011",
    serviceType: "Global Colour, Nano Plastia Spa",
    serviceCategory: "Treatments",
    gender: "Female",
    status: "Completed",
    price: 4800,
